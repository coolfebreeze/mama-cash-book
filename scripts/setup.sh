...
echo ""
echo "🌐 접속 주소:"
echo "   Grafana: http://\${GRAFANA_HOST:-localhost}:\${GRAFANA_PORT:-3000} (admin/admin123)"
echo "   Prometheus: http://\${PROMETHEUS_HOST:-localhost}:\${PROMETHEUS_PORT:-9090}"
echo "   Alertmanager: http://\${ALERTMANAGER_HOST:-localhost}:\${ALERTMANAGER_PORT:-9093}" 